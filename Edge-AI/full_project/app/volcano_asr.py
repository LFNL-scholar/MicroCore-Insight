...
class ASRProvider():
    def __init__(self):
        self.appid = "1040131635"
        self.cluster = "volcengine_input_common"
        self.access_token = "Lcv7ShPi4sA7YwLCPqfzT9qlp27vLAQC"
    ...
    async def speech_to_text(self, opus_data: List[bytes], session_id: str) -> Tuple[Optional[str], Optional[str]]:
        ...
        try:
            ...
            # 计算分片大小
            # 16000采样率 * 2字节采样宽度 * 1声道 = 每秒字节数
            bytes_per_sec = 16000 * 2 * 1
            segment_size = int(bytes_per_sec * self.seg_duration / 1000)
